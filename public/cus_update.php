...
$result = mysqli_query($connection,"SELECT * FROM customer");
 ...
 //Update Process 
 if(count($_POST)>0) {
    mysqli_query($connection,"UPDATE customer SET company='" . $_POST['company'] . "',contactName='" . $_POST['contactName'] . "', address1='" . $_POST['address1'] . "', telephone='" . $_POST['telephone'] . "', mobile='" . $_POST['mobile'] . "', email='" . $_POST['email'] . "', fax='" . $_POST['fax'] . "' WHERE id='" . $_POST['id'] . "'");
    $message = "Record Modified Successfully";
    }
    $result = mysqli_query($connection,"SELECT * FROM customer WHERE id='" . $_GET['id'] . "'");
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <form method="post" action="#" class="form-horizontal form-label-left" novalidate>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">نام شرکت <span
                                        class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" name="company" value="<?php echo $row['company']; ?>" class="form-control col-md-7 col-xs-12"
                                           required="required" type="text">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">نام مشتری <span
                                        class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" name="contactName" value="<?php echo $row['contactName']?>" class="form-control col-md-7 col-xs-12"
                                            required="required" type="text">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">آدرس <span
                                        class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" name="address1" value="<?php echo $row['address1']?>" class="form-control col-md-7 col-xs-12"
                                          required="required" type="text">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">تلفن <span
                                        class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" name="telephone" value="<?php echo $row['telephone']?>" class="form-control col-md-7 col-xs-12"
                                           required="required" type="text">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">مبایل <span
                                        class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" name="mobile" value="<?php echo $row['mobile']?>" class="form-control col-md-7 col-xs-12"
                                          required="required" type="text">
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">فکس <span
                                        class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" name="fax" value="<?php echo $row['fax']?>" class="form-control col-md-7 col-xs-12" 
                                         required="required" type="text">
                                </div>
                            </div>
