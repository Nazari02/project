...
$result = mysqli_query($connection,"SELECT * FROM supplier");
 ...
 //Update Process 
 if(count($_POST)>0) {
    mysqli_query($connection,"UPDATE supplier SET companyName='" . $_POST['companyName'] . "',contactName='" . $_POST['contactName'] . "', email='" . $_POST['email'] . "', mobile='" . $_POST['mobile'] . "', address='" . $_POST['address'] . "' WHERE id='" . $_POST['id'] . "'");
    $message = "Record Modified Successfully";
    }
    $result = mysqli_query($connection,"SELECT * FROM supplier WHERE id='" . $_GET['id'] . "'");
    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>تهیه کننده
                    <small>محتویات این صفحه مربوط حساب تهیه کنندگان میباشد.</small>
                </h3>
            </div>
                ...
                <div class="x_panel">
                    ...
                    <form method="post" action="#" class="form-horizontal form-label-left" novalidate>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" name="companyName" value="<?php echo $row['companyName']; ?>" class="form-control col-md-7 col-xs-12"
                                           required="required" type="text">
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">نام تهیه کننده <span
                                        class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">ایمیل <span
                                        class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" name="email" value="<?php echo $row['email']?>" class="form-control col-md-7 col-xs-12"
                                          required="required" type="text">
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" name="address" value="<?php echo $row['address']?>" class="form-control col-md-7 col-xs-12"
                                          required="required" type="text">
                                </div>
                            </div>
