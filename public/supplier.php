                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <p class="text-muted font-13 m-b-30">
                            جدول زیر قابلیت حذف تغییر و یا علاوه کردن تهیه کنندگان را دارد. 
                        </p>
                        ...
                        <table id="datatable" class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <a href="sup_update.php?id=<?php echo $row['id']; ?>">
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                data-target=".bs-example-modal-lg"><i class="fa fa-edit"></i> ویرایش
                                </button></a>

                                <!-- Delete button-->                                               
                                <a href="supplier.php?del=<?php echo $row['id']; ?>">         
