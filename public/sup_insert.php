...
{    
     ...
     $sql = "INSERT INTO supplier (companyName,contactName,email,mobile,address)
     VALUES ('$companyName','$contactName','$email','$mobile','$address')";
...
<head>
    ...
    <title>اصافه کردن تهیه کننده </title>
                    ...
                    <form method="post" action="#" class="form-horizontal form-label-left" novalidate>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" name="companyName" class="form-control col-md-7 col-xs-12"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" name="email" class="form-control col-md-7 col-xs-12"
                                          required="required" type="text">
                                </div>
                            </div>
                            <div class="item form-group">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" name="address" class="form-control col-md-7 col-xs-12"
                                          required="required" type="text">
                                </div>
                            </div>
